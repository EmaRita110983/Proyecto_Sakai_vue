...
const primaryColors = ref([
    { name: 'noir', palette: {} },
    // Bronce de marca de Clinia Doctor (#B9863B). Tonos derivados a mano con el
    // mismo algoritmo que usa `palette()` de @primeuix/themes (el que ya usa
    // useBranding.js para el color de cada médico), para que este swatch se
    // comporte exactamente igual que el resto y quede disponible como opción
    // para cualquier admin que quiera adoptar el color de casa de Clinia Doctor.
    { name: 'bronce', palette: { 50: '#FCF9F5', 100: '#EEE2D0', 200: '#E1CBAB', 300: '#D4B485', 400: '#C69D60', 500: '#B9863B', 600: '#9D7232', 700: '#825E29', 800: '#664A20', 900: '#4A3618', 950: '#2E220F' } },
...
// Solo queda la selección de color primario: Surface, Presets y Menu Mode se
// quitaron del panel a propósito (quedan fijos en sus valores de fábrica —
// surface por defecto, preset Aura, menú static) para no darle al usuario
// más opciones de las que necesita.
function updateColors(color) {
    ...
    if (usuario?.role === 'admin' && color.palette['500']) {
